 ...
 * {@code kkrepo.security.encryption.*} values. For contexts without Spring (e.g. the migration
...
public final class EncryptionSecrets {
  ...
  public static String credentialSecret() {
    return resolve(
        ...
        "kkrepo.security.encryption.credential-secret",
  ...
  public static String apiKeyPayloadSecret() {
    return resolve(
        ...
        "kkrepo.security.api-key-payload-secret",
